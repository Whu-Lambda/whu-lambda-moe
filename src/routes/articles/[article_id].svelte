<script>
  ...
  export let article = {
    id: 1,
    name: ' “开源软件供应链点亮计划——暑期2021”项目提案',
    author: 'whu-lambda',
    created_at: '2022-01-15',
    cover:
      'https://files.realpython.com/media/Build-a-Basic-Social-Network-with-Django-Part-3-Follows-and-Dweets_Watermarked.88e0447c3f73.jpg',
    content: `项目简介
...
2020 年，TUNA 基于自身与上游需求，共提出了涉及镜像站基础设施、应用软件移植与更新、发行版维护、性能优化等多个方面的 14 个项目，并有 8 个项目通过立项，7 个项目顺利结项，一个项目（将 xgboost 与 prophet 等数据科学软件库集成到 Debian GNU/Linux，学生周默，导师 Aron Xu）获评最佳质量奖。详情可见 TUNA 项目页面 和 官网公示。 TUNA 社区代表也参与了后续举办的开源软件供应链 2020 峰会（可见 TUNA 博客），与其他社区积极地进行交流。
